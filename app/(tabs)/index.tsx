  ...
  const generateBarcode = async () => {
    try {
      ...
      if (membershipDetails?.paymentStatus !== 'completed') {
        Alert.alert('Error', 'Please complete your payment to generate barcode');
        return;
      }
          ...
          {membershipDetails?.paymentStatus === 'completed' ? (
              ...
              >
                {barcodeLoading ? (
                  ...
                  <>
                    ...
                    <Text style={styles.checkInButtonText}>Generate Barcode</Text>
                  </>
                )}
              </TouchableOpacity>
            )
            ...
            <View style={styles.membershipCard}>
              <Text style={[styles.membershipLabel, { textAlign: 'center', color: '#EF4444' }]}>
                Complete your payment to generate barcode
              </Text>
            </View>
          )}
